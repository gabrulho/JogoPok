...
public class Batalha {
    ...
    public static void batalhar(Pokemon pokemon, String ataqueespecificonome, String treinadornome, Meowth meowth) throws InterruptedException {
        Scanner e = new Scanner(System.in);
        System.out.println(treinadornome + ": " + pokemon.getNome() + ", eu escolho você!\n");
        while (pokemon.getVida() > 0 && meowth.getVida() > 0) {
            Thread.sleep(1000);
            System.out.println("Deseja usar:\n1- Ataque Rapido\n2- " + ataqueespecificonome + "\n3- Esquiva");
